...
Визуальный конструктор блок-схем для автоматизации бизнес-процессов или обучения.

Честно признаться я боюсь, что с появлением LLM программисты могут исчезнуть. Имеется ввиду нормальные программисты, которые как минимум понимают, что такое алгоритм, понимают как устроен компьютер, а самое главное как работает любой процессор.

Вот это проект и призван помочь людям понять что такое алгоритм.
